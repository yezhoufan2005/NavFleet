...
| **下一步**     | **Phase 17 功能已收口，待负责人发版 1.4.0**：17A 聚合层 + 17B 报表页与导出 + 17C kiosk 认证与大屏页（WallView：KPI 带 + 地图主体 + 滚动告警 + 强制新鲜度指示，`meta.bare` 非交互）全部合入 main。剩最后一步 **发版 1.4.0**（负责人手动合 release-please PR + 打 tag） |
...
| 2    | **Phase 15** 用户体系与真 RBAC（1.2.0）   | 15A ✅ · 15B-1 ✅ · 15B-2 ✅ · 15C ✅ · 15D ✅ · 15E-1 ✅ · 15E-2 ✅（1.2.0 发版 PR 待负责人合） |
| 3    | **Phase 16** 告警体系深化（1.3.0）        | ✅ 已发版 `v1.3.0`                                                                               |
| 4    | **Phase 17** 报表与数据价值（1.4.0）      | 17A ✅ · 17B ✅ · 17C ✅（功能收口，1.4.0 发版 PR 待负责人合）                                   |
