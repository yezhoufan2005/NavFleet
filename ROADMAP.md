...
| **下一步**     | **Phase 15E**（会话管理 + 管理端 UI，**发版 1.2.0**）。15A–15D 均 ✅ 未发版。15E：会话可见性 + 强制下线、账号级登录锁定、管理页（用户/审计/个人中心改密）、`feat:` + `Release-As: 1.2.0` —— **发版 PR 合并与 tag 由负责人手动** |
...
| 2    | **Phase 15** 用户体系与真 RBAC（1.2.0）   | 15A ✅ · 15B-1 ✅ · 15B-2 ✅ · 15C ✅ · 15D ✅ · 15E 待办（发版） |
